...
const Amy = () => {
    ...
    return (
        ...
        <div className='container-fluid px-0 pb-5 col-lg-8 col-12 px-lg-0 px-3'>
        ...
        <Card className='d-flex flex-column mb-3 text-center mt-5 p-5'>
            ...
            <p className='h1' style={{color:colors[jobTitleIndex]}}>
            {jobTitles[jobTitleIndex]}
            </p>
        </Card>

        <Card className='d-flex flex-md-row flex-column mb-3'>
            <div className='col-md-5 col-12 my-auto w-100 d-flex mt-md-0 mt-5'>
            <img src='Amy.png' className='img-fluid ps-md-5 mx-md-0 mx-auto' alt='chatbot'/>
            </div>
        ...
        <Card className='d-flex flex-column mb-3 p-5'>
            ...
            <div className='flex-row d-flex'>
                <div className='col-md-4 col-12 flex-column px-3'>
