...
const Amy = () => {
    ...
    return (
        ...
        <div className='container-fluid px-0 pb-lg-5 pb-2 col-lg-8 col-12 px-lg-0 px-3'>
        ...
        <Card className='d-flex flex-lg-row flex-column mb-4' bottom> 
            <div className='col-lg-5 col-12 d-flex mt-lg-0 mt-5'>
                <img src='Amy.png' className='img-fluid ps-lg-5 mx-lg-0 mx-auto my-auto' alt='chatbot'/>
            </div>
        ...
        <Card className='d-flex flex-column mb-4 p-5' left> 
        ...
        <Card className='d-flex flex-column mb-4 p-5' right>
        ...
        <Card className='d-block column mb-4 p-5' bottom> 
        ...
        <Card className='d-flex flex-lg-row flex-column mb-4' left> 
        ...
        <Card className='d-flex flex-lg-row flex-column mb-4' right> 
            <div className='col-lg-3 col-12 d-flex'>
            <div className=' flex-grow-1' style={{backgroundColor:"#DCDDEF"}}/>
            </div>
            <div className='col-lg-9 col-12 p-5'>
